...
#define MIN_MULTI 0.1
    ...
    public:
        ...
        void reroute_reads_from_intip_to_edge(Edge& edge_des, std::string node_s, std::string node_e, std::string node_t);
        void add_virtual_reads(unsigned& removed_paths, int x, double identity, bool use_length = false);
